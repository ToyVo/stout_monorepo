 ...
 */
mutex mtx;
unsigned long long int Dim = 1000;
...
int main() {
  ...
  int averageParDurration = 0;
  int averageSeqDurration = 0;
  ...
  for (int trial = 0; trial < trials; trial++) {
    ...
    averageSeqDurration += duration.count();
    ...
    */
    ...
    averageParDurration += duration.count();
  ...
  cout << "average parallel durration: " << averageParDurration << endl;
  cout << "average sequential durration: " << averageSeqDurration << endl;
  return 0;
}
