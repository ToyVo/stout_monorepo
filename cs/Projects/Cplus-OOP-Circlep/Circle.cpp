...
int main() {
  ...
  cout << "The area of circle3 is " << circle3.getArea() << endl;

  cout << "The radius of circle1 is " << circle1.getRadius() << endl;
  cout << "The radius of circle2 is " << circle2.getRadius() << endl;
  cout << "The radius of circle3 is " << circle3.getRadius() << endl;
