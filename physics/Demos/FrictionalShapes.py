...
def main():
    ...
    objects: List[Particle] = [Wall(pos=Vec2(600, 20), normal=Vec2(0, 1), length=580, color=(0, 0, 0)),
                               ...
                               UniformPolygon(pos=Vec2(1000, 600),
                                              offsets=[Vec2(0, 0), Vec2(50, 0), Vec2(50, 50), Vec2(0, 50)]),
                               UniformPolygon(pos=Vec2(200, 800), offsets=[Vec2(0, 0), Vec2(50, 0), Vec2(50, 50)]),
                               UniformPolygon(pos=Vec2(400, 400),
                                              offsets=[Vec2(0, 0), Vec2(50, 0), Vec2(50, 50), Vec2(0, 50)]),
                               UniformPolygon(pos=Vec2(600, 200),
                                              offsets=[Vec2(0, 0), Vec2(50, 30), Vec2(50, 50), Vec2(0, 50)]),
                               UniformPolygon(pos=Vec2(800, 700),
        ...
        for e in pygame.event.get():
            if e.type == pygame.QUIT or e.type == pygame.KEYDOWN and e.key == pygame.K_ESCAPE:
                ...
                if e.key == pygame.K_UP:
                    gravity.g = Vec2(0, -9.8)
                elif e.key == pygame.K_DOWN:
                    gravity.g = Vec2(0, 9.8)
                elif e.key == pygame.K_LEFT:
                    gravity.g = Vec2(-9.8, 0)
